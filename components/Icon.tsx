...
// FIX: Use React.ReactElement to avoid issues with global JSX namespace.
const icons: Record<string, React.ReactElement> = {
  ...
  course: <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />,
  solve: <path strokeLinecap="round" strokeLinejoin="round" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />,
  quiz: <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />,
  summaries: <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 011.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 00-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a1.125 1.125 0 01-1.125-1.125v-9.25m9.75 11.625c.621 0 1.125-.504 1.125-1.125v-6.75c0-1.933-1.567-3.5-3.5-3.5H3.75a3.5 3.5 0 00-3.5 3.5v6.75c0 .621.504 1.125 1.125 1.125h9.75" />,
  formulas: <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.036.243c-2.132 0-4.14-.78-5.655-2.099m-6.75-.47A48.416 48.416 0 0112 4.5c2.291 0 4.545.16 6.75.47m-13.5 0c-1.01.143-2.01.317-3 .52m3-.52l-2.62 10.726c-.122.499.106 1.028.589 1.202a5.988 5.988 0 002.036.243c2.132 0 4.14-.78 5.655-2.099" />,
  ...
  admin: <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.226l.28-.1c.58-.208 1.22-.172 1.77.124l.036.019a1.002 1.002 0 001.076 0l.036-.019c.55-.295 1.19-.331 1.77-.124l.28.1c.55.219 1.02.684 1.11 1.226l.044.269c.074.456.074.924 0 1.38l-.044.269c-.09.542-.56 1.007-1.11 1.226l-.28.1c-.58.208-1.22.172-1.77-.124l-.036-.019a1.002 1.002 0 00-1.076 0l-.036.019c-.55.295-1.19.331-1.77-.124l-.28-.1c-.55-.219-1.02-.684-1.11-1.226l-.044-.269a8.25 8.25 0 010-1.38l.044-.269zM12 6.75a5.25 5.25 0 100 10.5 5.25 5.25 0 000-10.5zM12 8.25a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5z" />,
  ...
  'speaker-x-mark': <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5l-4.5 4.5M9 4.5l4.5 4.5M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75z" />,
